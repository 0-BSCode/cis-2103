...
public class EmployeeProjectV4 {
    /**
    ...
    public static void main(String[] args) {
        ...
        HourlyEmployee hEmp2 = new HourlyEmployee(3, "John", "Uyheng", "Pelaez", "13/03/2022", "09/02/2002", 42f, 10f);
